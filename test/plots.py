...
jetpt_fullrange.GetYaxis().SetTitle('Entries')
...
muonpt_fullrange.GetYaxis().SetTitle('Entries')
...
l1tpt.GetYaxis().SetTitle('Entries')
...
l1tpt_fullrange.GetYaxis().SetTitle('Entries')
