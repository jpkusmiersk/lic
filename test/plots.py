...
legend.AddEntry("histo","\eta>10","f")
legend.AddEntry("histo1","\eta>20","f")
legend.AddEntry("histo2","\eta>30","f")
legend.AddEntry("histo3","\eta>40","f")
#legend.AddEntry("histo1","l1phi","f")
#legend.AddEntry("histo2","p","f")
legend.Draw()
c1.Print("histo_jet_eta_odciecia_2.png")
