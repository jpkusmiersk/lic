...
#histo.GetXaxis().SetTitle('vertexz')
deltarml1t.SetTitle('\Delta R~between~muons~and~L1T~muons')
...
#histo.GetXaxis().SetTitle('vertexz')
deltarml1tpik.SetTitle('\Delta R_{min}~between~muons~and~L1T~muons')
...
legend.AddEntry("jetdphi","p_{T}","f")
#legend.Draw()
c26.Print("muon_l1t_deltaRpik.png")
...
pjeta200.Draw("AP")
pjeta200.SetTitle('Probabilty; jets \eta; Probability')
...
legend.SetTextSize(0.03)
legend.AddEntry("pjeta200","muon PAT p_{T}>5GeV","f")
